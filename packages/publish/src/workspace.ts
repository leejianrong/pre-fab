...
export interface SiteBuildData {
  ...
  pages: PageDocument[];
  posts: PostDocument[];
  /** KAN-1244 / ADR-0018 — same "own collection, own build-time-injected data" shape as `posts` above. Optional for the identical "existing direct test callers keep compiling" reason. */
