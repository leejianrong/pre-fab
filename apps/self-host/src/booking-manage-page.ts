/**
 * Self-host's own copy of apps/api/src/lib/booking-manage-page.ts —
 * deliberately duplicated, never imported (ADR-0010: this package must
 * never depend on the control plane). See that file's own comment for why
 * this is a small, self-contained HTML document rather than part of the
 * Astro-built site.
 */
